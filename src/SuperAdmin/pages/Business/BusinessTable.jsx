...
useEffect(() => {
  ...
  <Box mb={30}  style={{display:'flex', flexDirection:'row', justifyContent:'space-evenly'}}>
    ...
    <Box ><Badge variant="filled" fullWidth>Commercial Business</Badge></Box>
    <Box style={{display:'flex', flexDirection:'row', justifyContent:'left'}}><IconBuilding size={20} color="green" /><Text ml={5}>Intelligent Marketing Agent</Text></Box>
    <Box style={{display:'flex', flexDirection:'row', justifyContent:'left'}}><IconUser size={20} color="green" /><Text ml={5}>Mr TRA</Text></Box>
