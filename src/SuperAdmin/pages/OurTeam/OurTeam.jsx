...
function Card({ image, title, category, role }) {
...
const data = [
  {
    image:
      sirTRA,
    title: ' "I made sure IMA product was top-notch. I watched over its development and made sure everything was perfect."',
  ...
  },
  {
    image:
      Afnan,
    title: '"In this project, I worked as a Backend Developer and helped it progress smoothly."',
  ...
  },
  {
    image:
      Laraib,
      title: ' "In this project, I worked as a Frontend Developer and helped it progress smoothly.',
